...
class SuperAdminClassScreen extends StatefulWidget {
  final String classId;
  final String className;
  const SuperAdminClassScreen({
    super.key,
  ...
  @override
  State<SuperAdminClassScreen> createState() => _SuperAdminClassScreenState();
}

class _SuperAdminClassScreenState extends State<SuperAdminClassScreen> {
